...
public class AlipayWAPConfig {
	...
	// URL 调用定义
	public static String URL_CALLBACK; 		//get
	public static String URL_NOTIFY;		//post
	public static String URL_INTERRUPT;		//get
	
	// 请求参数定义
	//public static final String FORM_SELLER			= "WIDseller_email";
	public static String FORM_SUBJECT;
	public static String FORM_FEE; 						// 单位为分 ali为元 模块将转换为分
	
	// 接口定义
	public static ICreate iCreate;
	public static INotify iNotify;
	public static ICallback iCallback;
	public static IInterrupt iInterrupt;
