package com.share.mod.pay.ali.wap.util;
...
import com.share.mod.pay.ali.wap.AlipayWAPConfig;
import com.share.mod.pay.ali.wap.sign.MD5;
import com.share.mod.pay.ali.wap.sign.RSA;
import com.share.mod.pay.ali.wap.util.httpClient.HttpProtocolHandler;
import com.share.mod.pay.ali.wap.util.httpClient.HttpRequest;
import com.share.mod.pay.ali.wap.util.httpClient.HttpResponse;
import com.share.mod.pay.ali.wap.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayWAPConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayWAPConfig.key, AlipayWAPConfig.input_charset);
        }
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		if(AlipayWAPConfig.sign_type.equals("0001")) {
    			res_data = RSA.decrypt(res_data, AlipayWAPConfig.private_key, AlipayWAPConfig.input_charset);
    		}
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + AlipayWAPConfig.partner;
