...
public class AlipayNotify {
    ...
    public static Map<String, String> decrypt(Map<String, String> inputPara) throws Exception {
    	inputPara.put("notify_data", RSA.decrypt(inputPara.get("notify_data"), AlipayWAPConfig.private_key, AlipayWAPConfig.input_charset));
    	return inputPara;
    }
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, boolean isSort) {
        ...
        if(AlipayWAPConfig.sign_type.equals("MD5") ) {
        	isSign = MD5.verify(preSignStr, sign, AlipayWAPConfig.key, AlipayWAPConfig.input_charset);
        }
        if(AlipayWAPConfig.sign_type.equals("0001")){
        	isSign = RSA.verify(preSignStr, sign, AlipayWAPConfig.ali_public_key, AlipayWAPConfig.input_charset);
        }
        return isSign;
    }
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = AlipayWAPConfig.partner;
